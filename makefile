...
RICKY_DIR = stock-ricky
MICKY_DIR = commande-micky
DASHBOARD_DATA_DIR = données-dashboard
...
run-app : ${EXE_PATH} ${RICKY_DIR} ${MICKY_DIR}
	cp cmd/main/stock-ricky/2016-02-17-n1-produit_màj.csv ${REL_DIR}/${RICKY_DIR} && \
	cp cmd/main/stock-ricky/2016-02-18-n1-entree.csv ${REL_DIR}/${RICKY_DIR} && \
	cp cmd/main/stock-ricky/2016-02-18-n2-sortie.csv ${REL_DIR}/${RICKY_DIR} && \
	cp cmd/main/stock-ricky/2016-02-18-n3-inventaire.csv ${REL_DIR}/${RICKY_DIR} && \
	cd ${REL_DIR} && \
	./${EXE} && \
	rm ${EXE}
