...
func TestMain(t *testing.T) {
	...
	cmd1 := sk.Cmd{
		T:     stockSk.InCmd{"Carlsbourg", items.Items{IsoK: Iso4}, "2016-01-27"},
		Route: stockRoute,
	}

	cmd2 := sk.Cmd{
		T:     stockSk.OutCmd{"Carlsbourg", items.Items{IsoK: Iso1}, "2016-01-28"},
		Route: stockRoute,
	}

	cmd3 := sk.Cmd{
		T:     stockSk.InventoryCmd{"Carlsbourg", items.Items{IsoK: Iso2}, "2016-01-29"},
		Route: stockRoute,
	}
