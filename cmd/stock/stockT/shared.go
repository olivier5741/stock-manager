...
var (
	AspK  = "aspirine"
	Asp   = items.Prod(AspK)
	Asp1  = items.Item{Asp, val.NewVal(unitval.T{itemT.Pillule, 1})}
	Asp5  = items.Item{Asp, val.NewVal(unitval.T{itemT.Pillule, 5})}
	Asp6  = items.Item{Asp, val.NewVal(unitval.T{itemT.Pillule, 6})}
	Asp8  = items.Item{Asp, val.NewVal(unitval.T{itemT.Pillule, 8})}
	Asp15 = items.Item{Asp, val.NewVal(unitval.T{itemT.Pillule, 15})}
	Asp20 = items.Item{Asp, val.NewVal(unitval.T{itemT.Pillule, 20})}
	IsoK  = "isobétadine"
	Iso   = items.Prod(IsoK)
	Iso0  = items.Item{Iso, val.NewVal(unitval.T{itemT.Pillule, 0})}
	Iso1  = items.Item{Iso, val.NewVal(unitval.T{itemT.Pillule, 1})}
	Iso2  = items.Item{Iso, val.NewVal(unitval.T{itemT.Pillule, 2})}
	Iso3  = items.Item{Iso, val.NewVal(unitval.T{itemT.Pillule, 3})}
	Iso4  = items.Item{Iso, val.NewVal(unitval.T{itemT.Pillule, 4})}
	Iso7  = items.Item{Iso, val.NewVal(unitval.T{itemT.Pillule, 7})}
	Iso10 = items.Item{Iso, val.NewVal(unitval.T{itemT.Pillule, 10})}
	Iso20 = items.Item{Iso, val.NewVal(unitval.T{itemT.Pillule, 20})}
